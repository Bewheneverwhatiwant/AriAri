    ...
    return (
        <MainContainer>
            ...
            <CustomRow>
                ...
                <ContainerRow>
                    <Textarea />
                    <DetailButton onClick={gocantsell}>판매 금지 상품 확인하기</DetailButton>
                </ContainerRow>
            </CustomRow>
            ...
            <CustomRow>
                ...
                <ContainerRow>
                    <Textarea />
                    <DetailButton onClick={gopointmap}>가격 책정 길라잡이 읽어보기</DetailButton>
                </ContainerRow>
            </CustomRow>
            <Sizedbox />
            <FinalButton onClick={enroll}>내 남한 상품 등록하기</FinalButton>
        </MainContainer>
    );
};
